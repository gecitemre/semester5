...
public class Evaluation {
    ...
    private static String user = "e2521581"; // userName
    private static String password = "Dfl1UIs_px0qy9GL"; // password
    private static String host = "momcorp.ceng.metu.edu.tr"; // host name
    private static String database = "db2521581"; // database name
